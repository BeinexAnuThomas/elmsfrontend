...
@Component({
  selector: 'app-allapprovedleaves',
  templateUrl: './allapprovedleaves.component.html',
  styleUrls: ['./allapprovedleaves.component.scss']
})
export class AllapprovedleavesComponent implements OnInit {
